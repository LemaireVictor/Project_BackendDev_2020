...
namespace JAQ_BackendDev.Web.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new AppUser { UserName = Input.Email, Email = Input.Email, DateOfBirth = Input.BirthDate, Firstname = Input.FirstName, Lastname = Input.LastName};
