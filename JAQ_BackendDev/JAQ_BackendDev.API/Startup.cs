...
namespace JAQ_BackendDev.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<JAQ_BackendDevDbContext>(options => options.UseSqlServer(connectionString));
            ...
            services.AddIdentity<AppUser, IdentityRole>().AddEntityFrameworkStores<JAQ_BackendDevDbContext>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, JAQ_BackendDevDbContext context, IServiceProvider serviceProvider)
        {
            if (env.IsDevelopment())
            {
